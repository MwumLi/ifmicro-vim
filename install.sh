...
backup_configs=('.vimrc' '.vim' '.vimrc.plugin' '.vimrc.custom' '.vimrc.funcs' '.vimrc.keys' '.vimrc.theme' '.vimrc.theme.plugins')
# all new configuration
vimrcs=("vimrc" "vimrc.plugins" "vimrc.theme" "vimrc.plugins.config" "vimrc.custom" "vimrc.funcs" "vimrc.keys")
# vim user dirctory
